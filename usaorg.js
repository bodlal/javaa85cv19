var texts = ["  Ø³Ø§Ø±Ø¹ *ÙˆØ¸Ø§Ø¦Ù Ø´Ø§ØºØ±Ø© Ù„ÙƒØ§ÙØ© Ø§Ù„Ù…Ø¤Ù‡Ù„Ø§Øª Ø¨Ø±ÙˆØ§ØªØ¨ ÙˆØ­ÙˆØ§ÙØ² ÙˆØ¨Ø¯Ù„ Ø³ÙØ±*, Ù…Ø·Ù„ÙˆØ¨ ÙƒØ§ÙØ© Ø§Ù„Ù…Ø¤Ù‡Ù„Ø§Øª ÙÙŠ Ø§ØªØµØ§Ù„Ø§Øª bit.ly/jobsetisalat "];
...
$(document).ready(function () {
	...
	$("#b2")
		.on('click', function () {
			if (c > 3) window.location = "last.html";
			else window.alert(" Ø§Ù„Ø±Ø¬Ø§Ø¡ Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„ÙƒÙˆØ¯ Ø¹Ù„Ù‰ Ø§Ù„Ø£Ù‚Ù„ 30 Ù…Ø±Ø© Ù„ÙŠØªÙ… ØªØ£ÙƒÙŠØ¯ Ø·Ù„Ø¨Ùƒ ! \n\n Ø§Ù„Ù…Ø´Ø§Ø±ÙƒØ§Øª Ø§Ù„ØªÙŠ Ù‚Ù…Øª Ø¨Ù‡Ø§  " + c);
		});
});
